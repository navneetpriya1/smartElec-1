"""
Django settings for smartElecAdmin project.
...
SECRET_KEY = 'v)($jo8kr*r8yvcuep^s%a10)@1=+3jw2g%(43j$5pfm9u#o#y'
...
ROOT_URLCONF = 'smartElecAdmin.urls'

WSGI_APPLICATION = 'smartElecAdmin.wsgi.application'
